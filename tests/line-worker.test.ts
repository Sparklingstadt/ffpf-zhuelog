...
// Scenarios use separate servers and workers; run them together so each
// 500ms no-busy-poll window overlaps instead of adding up.
suite("worker scheduling", { concurrency: true }, () => {
